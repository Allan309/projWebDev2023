...
export class RegisterComponent implements OnInit, OnDestroy {
	...
	form: FormGroup = new FormGroup({
		...
		date_naissance: new FormControl(new Date("04/06/1998"), [Validators.required]),
		image: new FormControl(null),
	})

	constructor(private authService: AuthService, private imageCompressService: NgxImageCompressService) { }
